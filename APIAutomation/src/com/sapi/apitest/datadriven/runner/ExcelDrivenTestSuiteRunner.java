 ...
 *
 */
public class ExcelDrivenTestSuiteRunner {
    ...
    public static void main(String[] args) {
        ...
        Class<?>[] runnerClass = RunnerFactory.createRunnerClass("geotestsuite");
        if(null == runnerClass){
            logger.error("the module specified doesn't exist.");
        }
        results.put(
                "Geo test suite",
                JUnitCore.runClasses(RunnerFactory.createRunnerClass("geotestsuite")));
        results.put("Web API test suite",
                JUnitCore.runClasses(TestWebAPIConsistency.class));
